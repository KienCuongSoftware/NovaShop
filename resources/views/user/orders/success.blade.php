...
<div class="text-center py-5">
    ...
    <p class="text-muted mb-2">Đơn hàng #{{ $order->id }} của bạn đã được tạo. Chúng tôi sẽ xử lý và liên hệ với bạn sớm.</p>
    @if($order->estimatedDeliveryDateRange())
        <p class="mb-4"><strong>Dự kiến nhận hàng:</strong> {{ $order->estimatedDeliveryDateLabel() }}</p>
    @endif
