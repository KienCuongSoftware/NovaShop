...
(function() {
    ...
    function updateState() {
        ...
        if (v) {
            ...
            priceEl.textContent = effectivePrice.toLocaleString('vi-VN') + '₫';
            ...
            if (flashPriceRow && flashPriceEl) {
                if (v.flash_price != null && v.flash_remaining > 0) {
                    ...
                    flashPriceEl.textContent = effectivePrice.toLocaleString('vi-VN') + '₫';
                    if (flashOldPriceEl) {
                        flashOldPriceEl.style.display = '';
                        flashOldPriceEl.innerHTML = '<s>' + v.price.toLocaleString('vi-VN') + '₫</s>';
                    }
                    if (flashDiscountEl) {
            ...
            if (flashPriceRow && flashPriceEl) {
                ...
                if (firstFlash) {
                    ...
                    if (flashCardEl) flashCardEl.style.display = '';
                    flashPriceRow.style.display = '';
                    flashPriceEl.textContent = eff.toLocaleString('vi-VN') + '₫';
                    if (flashOldPriceEl) {
                        flashOldPriceEl.style.display = '';
                        flashOldPriceEl.innerHTML = '<s>' + firstFlash.price.toLocaleString('vi-VN') + '₫</s>';
                    }
                    if (flashDiscountEl) {
