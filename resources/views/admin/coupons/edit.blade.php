                    ...
                    <div class="row">
                        <div class="col-md-4 form-group mb-2">
                            ...
                            <select name="user_segment" class="form-control">
                                ...
                                <option value="vip" {{ old('user_segment', $coupon->user_segment ?? 'all') === 'vip' ? 'selected' : '' }}>Chỉ khách VIP</option>
                            </select>
                            <small class="text-muted">Có thể kết hợp với đơn đầu / sinh nhật.</small>
                        </div>
                        <div class="col-md-4 form-group mb-2">
                    ...
                    <div class="row align-items-end mt-2">
                        <div class="col-md-4 form-group mb-0">
                            <div class="custom-control custom-checkbox">
                                ...
                                <input type="checkbox" name="birthday_only" value="1" class="custom-control-input" id="birthday_only" {{ old('birthday_only', $coupon->birthday_only) ? 'checked' : '' }}>
                                <label class="custom-control-label" for="birthday_only">Chỉ trong khoảng sinh nhật</label>
                            </div>
                            <small class="text-muted">Cần ngày sinh trên tài khoản.</small>
                        </div>
                        <div class="col-md-4 form-group mb-0">
                            <label>± ngày quanh sinh nhật</label>
                            <input type="number" name="birthday_window_days" class="form-control" min="0" max="60" value="{{ old('birthday_window_days', $coupon->birthday_window_days ?? 7) }}">
                        </div>
                    </div>
                </div>
            </div>
